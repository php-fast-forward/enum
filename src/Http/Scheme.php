...
namespace FastForward\Enum\Http;
...
enum Scheme: string implements DescribedEnumInterface, LabeledEnumInterface
{
    use Comparable;
    use HasLabel;
    use HasNameLookup;
    ...
    {
        return match ($this) {
            self::Http => 'Plain HTTP transport without transport-layer encryption.',
            self::Https => 'HTTP transport secured with TLS encryption.',
        };
    }
